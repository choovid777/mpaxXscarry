...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
  ...
  // Warna tema MERAH / BIRU MODERN (Kombinasi Cyberpunk Gelap)
  static const Color bgDark = Color(0xFF0A0E27);
  static const Color cardDark = Color(0xFF1A1F3F);
  static const Color accentRed = Color(0xFF3B82F6); // Diubah ke Biru Neon Modern agar selaras
  ...
  // Palet Warna Tambahan khusus untuk Panel Baru agar SAMA PERSIS dengan Foto
  static const Color panelBg = Color(0xFF11162D);
  static const Color panelBorder = Color(0xFF1E264F);
  static const Color iconBlue = Color(0xFF43A5FE);

  Color get glassPrimary => const Color(0x1AFFFFFF);
  Color get glassSecondary => const Color(0x0DFFFFFF);

  LinearGradient get primaryGradient => const LinearGradient(
        colors: [Color(0xFF3B82F6), Color(0xFF1D4ED8)], // Gradient Biru Premium
        begin: Alignment.topLeft,
        end: Alignment.bottomRight,
      );

  LinearGradient get secondaryGradient => const LinearGradient(
        colors: [Color(0xFF142244), Color(0xFF7FFFD4)],
        begin: Alignment.topLeft,
        end: Alignment.bottomRight,
      );
  ...
  Future<void> _fetchActiveSenders() async {
    ...
    try {
      final res = await http.get(
        Uri.parse("http://188.166.180.7:3000/mySender?key=${widget.sessionKey}"),
      );
  ...
  Future<void> _sendBug() async {
    ...
    try {
      final res = await http.get(
        Uri.parse("http://188.166.180.7:3000/sendBug?key=$key&target=$rawInput&bug=$selectedBugId&senderType=$_selectedSenderType",
        ),
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.start, // Perbaikan di bagian ini
                      children: [
                        Container(
                          width: 70,
                          height: 70,
                      ...
                      children: [
                        Expanded(
                          child: _buildStatusColumn(
                            ...
                            glowColor: const Color(0xFFFF7A00).withOpacity(0.15),
                            title: "Gacor",
                            subtitle: "Ratting Global",
                          ),
                        ),
                        Container(
                          height: 40,
                        ...
                        Expanded(
                          child: _buildStatusColumn(
                            ...
                            glowColor: const Color(0xFF4ADE80).withOpacity(0.25),
                            title: "${widget.listBug.length}",
                            subtitle: "Total Payload",
                            bottomText: "${widget.listBug.length} Tersedia",
                          ),
                        ),
                        Container(
                          height: 40,
                        ...
                        Expanded(
                          child: _buildStatusColumn(
                            ...
                            glowColor: const Color(0xFFFFC700).withOpacity(0.15),
                            title: "Fast Send",
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final itemGradient = isSelected
                            ...
                            : const LinearGradient(
                                colors: [Color(0xFF11162D), Color(0xFF0D1127)],
                                begin: Alignment.topLeft,
                                end: Alignment.bottomRight,
                              );
                            ...
                            child: Column(
                              ...
                              children: [
                                  ...
                                  children: [
                                    ...
                                    GestureDetector(
                                      ...
                                      child: Container(
                                        ...
                                        child: const Icon(Icons.refresh_rounded, color: accentRed, size: 16),
                                      ),
                                    ),
                                  ],
                                ),
                                ...
                                if (_isLoadingSenders)
                                  ...
                                  Text(
                                    _senderError!,
                                    style: const TextStyle(color: accentRed, fontSize: 12),
                                  )
                  ...
                  // ========================================================
                  // TOMBOL BARU: SEND BUG ATTACK (SAMA PERSIS SEPERTI DI FOTO)
                  // ========================================================
                  AnimatedBuilder(
                    ...
                    builder: (context, child) {
                      return Container(
                        ...
                        height: 58,
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(24), // Sudut melengkung halus premium
                          gradient: const LinearGradient(
                            colors: [
                              Color(0xFF60A5FA), // Border luar bercahaya terang
                              Color(0xFF1D4ED8),
                            ],
                          ),
                          boxShadow: [
                            // Efek double neon glow (Glow utama + pendaran tipis)
                            BoxShadow(
                              color: const Color(0xFF3B82F6).withOpacity(0.4 * _pulseController.value),
                              blurRadius: 16,
                              spreadRadius: 1,
                              offset: const Offset(0, 4),
                            ),
                        ...
                        // Container pembentuk gradasi isi & garis dalam border tebal halus
...
class _GridPainter extends CustomPainter {
  static const Color gridColor = Color(0xFF3B82F6); // Menyelaraskan dot grid ke warna biru cerah
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final dotPaint = Paint()
      ..color = gridColor.withOpacity(0.07)
